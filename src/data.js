...
const CAT_META = {
  "Breaking":   { icon: "🚨", color: "#CE1126", img: "https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=600&q=80" },
  "News":       { icon: "📰", color: "#1877F2", img: "https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=600&q=80" },
  "Weather":    { icon: "🌤️", color: "#1877F2", img: "https://images.unsplash.com/photo-1561553873-e8491a564fd0?w=600&q=80" },
  "Traffic":    { icon: "🚗", color: "#FF6B35", img: "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=600&q=80" },
  "Sports":     { icon: "⚽", color: "#2d9e6b", img: "https://images.unsplash.com/photo-1522778119026-d647f0596c20?w=600&q=80" },
  "Lifestyle":  { icon: "❤️", color: "#FF6B35", img: "https://images.unsplash.com/photo-1516483638261-f4dbaf036963?w=600&q=80" },
  "World News": { icon: "🌍", color: "#7B2FBE", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&q=80" },
