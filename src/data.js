export const ARTICLES = [
  { id:1, cat:"Breaking", icon:"🚨", color:"#CE1126", title:"Fatal accident on Mosta bypass — one dead, traffic halted", excerpt:"A two-vehicle collision on the Mosta bypass this morning has resulted in one fatality and serious injuries to two others. Emergency services are on the scene.", time:"2 min ago", source:"Times of Malta", img:"https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=600&q=80", breaking:true },
  ...
  { id:3, cat:"Sports", icon:"⚽", color:"#2d9e6b", title:"Hibernians win BOV Premier League title with stunning 3-1 win", excerpt:"Hibernians FC clinched the BOV Premier League title last night with a commanding victory over Valletta FC at the National Stadium.", time:"1 hr ago", source:"Malta Sports", img:"https://images.unsplash.com/photo-1522778119026-d647f0596c20?w=600&q=80" },
  ...
  { id:6, cat:"World News", icon:"🌍", color:"#7B2FBE", title:"Major earthquake strikes Turkey — 6.8 magnitude, casualties reported", excerpt:"A powerful earthquake has struck central Turkey. Confirmed by BBC, Reuters, AP and CNN. Rescue teams are being deployed.", time:"30 min ago", source:"Reuters · BBC · AP", img:"https://images.unsplash.com/photo-1590845947376-2638caa89309?w=600&q=80", breaking:true },
  { id:7, cat:"Culture", icon:"🎭", color:"#E8B922", title:"Valletta International Arts Festival kicks off this weekend", excerpt:"Over 60 events spanning theatre, music and visual arts across the historic bastions of Valletta. Free entry to most events.", time:"3 hrs ago", source:"MaltaToday", img:"https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=600&q=80" },
  { id:8, cat:"Health", icon:"🏥", color:"#2d9e6b", title:"New state-of-the-art healthcare centre opening in Gozo", excerpt:"Health Minister confirms a new facility for Gozo will open before year-end, reducing the need to travel to Malta for specialist care.", time:"5 hrs ago", source:"Times of Malta", img:"https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600&q=80" },
];
